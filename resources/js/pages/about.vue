    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12 Tpadding10">
                <button type="button" class="btn btn-outline-danger text-white">Start Right Now</button>
            </div>
        </div>
    </div>
</div>
...
.paddingTB60 {
   ...
   .image-aboutus-banner {
    background: linear-gradient(rgba(0,0,0,.7), rgba(0,0,0,.7)), url("https://scontent.fdac24-4.fna.fbcdn.net/v/t39.30808-6/301946070_596756181967689_8309313720025778534_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=e3f864&_nc_eui2=AeHps5y9OPCQP5IjlTxoRgETb1jCp7AK0TpvWMKnsArROjmh1qBdTxjrNG41a2A9Xgb3Br1ppOlecTYkccSxa4Zb&_nc_ohc=52gTSYqzzXQAX-Yfurv&tn=KAyvwn3416vayGDI&_nc_ht=scontent.fdac24-4.fna&oh=00_AfDsUztzrBRTzWxmyxo9-fboSZzNWykhC4p9qCN-tIZ1Dw&oe=638A3E84");
